...
public class Hotbar : MonoBehaviour
{
    ...
    [SerializeField]
    private List<Button> survivalButtons;
    [SerializeField]
    ...
    [SerializeField]
    private Image actBorder;
    private List<Color> colours;
    [SerializeField]
    private Sprite advance;
    [SerializeField]
    ...
    private void HoverDesc(Button b, bool check) {
        if (check)
        {
            ...
            if (found)
            {
                ...
                hoverBody.text = "SPEED             " + (currentAttack[i].speed + speed) + "<br>ACCURACY     " + ((10 - currentAttack[i].accuracy + accuracy + 1)*10) + "%<br>WOUND           " + wound + "%<br>CRIT                " + ((luck + currentAttack[i].luck) * 10) + "%";
            }
            else
            {
                i = 0;
                ...
                else
                {
                    ...
                    if (i == 0)
                    {
                        ...
                        hoverBody.text = "Move up to x squares away";
                    }
                    else
                    {
